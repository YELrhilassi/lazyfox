...
// the suites/*.mjs modules (command center, content script, sessions/status
// bar, split view, options); this entry point boots Firefox, installs the
// add-on, runs the selected groups and reports.
//
// Run:  node scripts/bidi/test.mjs [--suite name] [--group name] [--only text]
...
import * as commandcenter from "./suites/commandcenter.mjs";
import * as content from "./suites/content.mjs";
import * as sessions from "./suites/sessions.mjs";
import * as split from "./suites/split.mjs";
import * as options from "./suites/options.mjs";
